 ...
 **************************************************************** **/
	...
	function relative_time(time_value) {
		...
		if (delta < 60) {
            ...
            return 'single a minute ago';
		} else if(delta < (60*60)) {
			return (parseInt(delta / 60)).toString() + ' minutes ago';
		} else if(delta < (120*60)) {
            return 'single an hour ago';
		} else if(delta < (24*60*60)) {
            return 'single ' + (parseInt(delta / 3600)).toString() + ' hours ago';
