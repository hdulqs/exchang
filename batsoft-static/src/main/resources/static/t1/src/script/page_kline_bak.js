   ...
   var U = require('./module_utils');
    function init() {
        ...
        DarkTheme.prototype.__construct = function () {
            this._colors = [];
            this._colors[Theme.Color.Positive] = "#96b105";
            this._colors[Theme.Color.Negative] = "#ff175e";
            ...
            this._colors[Theme.Color.Background] = "#272727";
        ...
        var RequestData = function (showLoading) {
            ...
            $(document).ready(GLOBAL_VAR.G_HTTP_REQUEST = (function (url, time, market) {
                var stompClient;
...
;
            ...
            })(GLOBAL_VAR.url, GLOBAL_VAR.time_type, GLOBAL_VAR.market_from));
        };
