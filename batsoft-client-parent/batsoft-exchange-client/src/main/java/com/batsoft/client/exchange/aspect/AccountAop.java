package com.batsoft.client.exchange.aspect;
...
public class AccountAop {
    ...
    /**
     * 对com.batsoft.app.system.Main loginCheck方法初始化 用户账户到缓存
     */
    @Pointcut("execution(* com.batsoft.client.*.Main.loginCheck(..))")
    public void webLog() {
    }
    ...
    public void doAfterReturning(Object ret) throws Throwable {
    	...
    	//  customerAccountService.flushRedisAccountByCustomerId(UserUtils.getUser().getId());
        ...
        // entrustIngService.flushRedisEntrustByCustomerId(UserUtils.getUser().getId());
    ...
    private final class FlushRedisAccountRunnableImpl implements Runnable {
		...
		public FlushRedisAccountRunnableImpl(CustomerAccountService customerAccountDao, String userId) {
			super();
			this.customerAccountService = customerAccountDao;
			this.userId = userId;
		}
