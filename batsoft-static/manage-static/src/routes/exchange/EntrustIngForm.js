...
class EntrustIngForm extends BaseForm {
  state = {
    formType: 'add',
  };
  ...
  componentDidMount() {
    ...
    if (match.params.id !== undefined) {
      ...
      this.find('entrustIng/find',{id: match.params.id});
    }
  }
  ...
  render() {
    const {entrustIng: {findData}, form, dispatch, submitting} = this.props;
    ...
    const validate = () => {
      validateFieldsAndScroll((error, params) => {
        if (!error) {
          ...
          this.add('entrustIng/add',params,this.addCallBack);
        }
      });
    };
        ...
        return (
          ...
          >
            <Icon type="exclamation-circle"/>
                ...
                submitting: loading.effects['entrustIng/add'],
                }))(Form.create()(EntrustIngForm));
