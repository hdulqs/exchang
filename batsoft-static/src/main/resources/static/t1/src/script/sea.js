...
seajs.config({
    alias: {
        ...
        "jquery_form":DEV+"/plugins/jquery/jquery.form",
        ...
        "jquery_pagination":DEV + "/plugins/jPagination/jqpaginator.min",
        ...
        "numeral":DEV+"/plugins/numeral.min",
        "laydate":DEV+"/plugins/laydate/laydate",
        "layer":DEV+"/plugins/layer/layer",
        "clipboard":DEV+"/plugins/clipboard.min",
        "loadjs": DEV + "/loadjs",
    ...
    paths: {"dev": "static/t1/src/script", "dist": "static/t1/dist/script"},
    preload: ["jquery","jsviews","tether", "jquery_datepicker_moment", "socketjs","stomp","loadjs", Function.prototype.bind ? "" : "es5-safe", this.JSON ? "" : "json", !!window.L ? "" : "lang"],
    debug: false,
